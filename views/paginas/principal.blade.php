...
<html lang="en">
  ...
  <link rel="stylesheet" href="{{asset('css/css.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('css/bootstrap-icon.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('fontawesome-free-6.1.1-web/all.css')}}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
      <a href="/" class="navbar-brand d-flex align-items-center">
        <h1 class="mb-0 text-white">Controle de Formação</h1>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a href="/pautas" class="nav-link text-white">
              <i class="fas fa-clipboard-list"></i> Adicionar Pauta
            </a>
          </li>
          <li class="nav-item">
            <a href="/usuarios" class="nav-link text-white">
              <i class="fas fa-users"></i> Meus Controles
            </a>
            <li class="nav-item">
            <a href="minhas_pautas" class="nav-link text-white">
              <i class="fas fa-clipboard-list"></i> Ver Pautas
            </a>
          </li>
        </ul>
      </div>
    ...
    <footer>
      <p>@2024</p>
    <p>Toods os direitos reservados</p>  
    </footer>
